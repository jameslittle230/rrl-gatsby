...
class Nav extends React.Component {
  ...
  getCurrentStateName() {
    switch(this.state.currentAnimationState) {
      case this.animationStates.closed: return styles.closed;
      case this.animationStates.open: return styles.open;
      case this.animationStates.closing: return styles.closing;
      default: return null;
    }
  }
